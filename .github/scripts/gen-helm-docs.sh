...
readme_template="${repository}/.github/scripts/templates/README.md.gotmpl"
readme_config_template="${repository}/.github/scripts/templates/README_CONFIG.md.gotmpl"
